...
class VeomniFlopsCounter:
    ...
    def _estimate_qwen_vit_flop(self, image_seqlens, config):
        ...
        is_qwen3_vl = hasattr(config, "deepstack_visual_indexes")
        is_qwen2_or_3_vl = is_qwen2_vl or is_qwen3_vl
        is_qwen2_5 = not is_qwen2_or_3_vl
        ...
        # Qwen 2.5 / 3 VL uses SiLU, thus 3.
        ...
        full_attn_layer_num = config.depth if is_qwen2_or_3_vl else len(config.fullatt_block_indexes)
