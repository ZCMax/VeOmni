...
srun torchrun --nnodes=$SLURM_NNODES --nproc_per_node=8 \
    ...
    --data.train_path configs/multimodal/data/internvl3_5_toy_data.yaml \
    --data.train_size 100_000_000 \
    --train.global_batch_size 32 \
    --train.save_steps 1000 \
    --train.output_dir results/Qwen2.5-VL-7B-InternVL-Tiny-SFT \
    --train.ulysses_parallel_size 4 \
    --train.data_parallel_replicate_size 4 \
    --train.use_wandb False 2>&1 | tee log_test.txt